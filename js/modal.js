...
<div class="btn-category pb-2 p-0 col-11 d-flex flex-wrap justify-content-evenly">
    <button class="btn btn-light col-5 m-1">Chico</button>
    <button class="btn btn-light col-5 m-1">Mediano</button>
    <button class="btn btn-light col-5 m-1">Grande</button>
    <button class="btn btn-light col-5 m-1">Extragrande</button>
</div>
