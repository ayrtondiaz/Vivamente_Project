...
<div class="d-flex flex-wrap justify-content-evenly">
                <div class="col-lg-4 col-10 justify-content-start">                 
                <div class="card-des">
                <div class="pos">
                ...
                <h2 class="card-txt f-reg " style="color: white" id="nombre-prod">Maceta de yerba</h2>
                <br>
                </div>
                <div class="justify-content-start">
                ...
                <div class="col-lg-4 col-10 justify-content-start">                 
                  ...
                  <div class="justify-content-start">
                  <h2 class="card-txt f-reg " style="color: white" id="nombre-prod">Etiqueta Plantable</h2>
                  <br>
                  </div>
                  <div class="justify-content-start">
                  ...
                  <div class="col-lg-4 col-10 justify-content-start">                 
                    ...
                    <div class="justify-content-start">
                    <h2 class="card-txt f-reg " style="color: white" id="nombre-prod">Vela en frasco</h2>
                    <br>
                    </div>
                    <div class="justify-content-start">
