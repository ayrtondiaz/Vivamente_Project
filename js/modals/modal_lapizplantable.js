...
<div class="col-lg-4 pl-lg-5 p-lg-4 justify-content-center">
    <img src="../assets/img/productos/productos/lápiz plantable.webp" class="d-none d-lg-flex col-12 img-modal">
...
<div class="d-flex flex-row col-12">
    ...
    <a href="#" class="modal__close mc6 justify-self-end col-2 col-sm-1"><b class="align-self-center">Cerrar</b></a>
</div>
...
<img src="../assets/img/productos/productos/lápiz plantable.webp" class="col-12 d-flex p-3 d-lg-none align-self-center  img-modal">
