...
<div class="col-lg-5 p-lg-4 d-flex flex-row-reverse flex-wrap text-left">
    <img src="../assets/img/productos/productos/portasahumerio.webp" class="d-none d-lg-inline-flex p-2 pt-0 col-11 img-modal mt-5">
...
<div class="d-flex flex-row justify-self-end col-12">
    <h2 class="f-reg align-self-center col-10 col-sm-11 p-sm-3 p-lg-0 pt-lg-5"><b>Porta Sahumerio</b></h2>
